...
namespace Core\PhpSpreadsheet\ZipStream;

use Psr\Http\Message\StreamInterface;
use Core\PhpSpreadsheet\ZipStream\Exception\OverflowException;
use Core\PhpSpreadsheet\ZipStream\Option\Archive as ArchiveOptions;
use Core\PhpSpreadsheet\ZipStream\Option\File as FileOptions;
use Core\PhpSpreadsheet\ZipStream\Option\Version;

/**
 * Core\PhpSpreadsheet\ZipStream
 *
 ...
 *
 *     $zip = new Core\PhpSpreadsheet\ZipStream('example.zip');
 *
 ...
 *   $zip = new Core\PhpSpreadsheet\ZipStream('some_files.zip');
 *
 *   // list of local files
...
class ZipStream
{
    ...
    /**
     * Create a new Core\PhpSpreadsheet\ZipStream object.
     *
     * Parameters:
     *
     ...
     *   large_file_size) is extremely slow, because Core\PhpSpreadsheet\ZipStream has to pass
     ...
     *   $zip = new Core\PhpSpreadsheet\ZipStream('foo.zip');
     *
     *   // create a new zip file named 'bar.zip' with a comment
     *   $opt->setComment = 'this is a comment for the zip file.';
     *   $zip = new Core\PhpSpreadsheet\ZipStream('bar.zip', $opt);
     *
     * Notes:
     *
     ...
     *
     * @return void
     * @throws \Core\PhpSpreadsheet\ZipStream\Exception\FileNotFoundException
     * @throws \Core\PhpSpreadsheet\ZipStream\Exception\FileNotReadableException
     */
