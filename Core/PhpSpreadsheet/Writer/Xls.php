...
use Core\PhpSpreadsheet\Shared\Drawing as SharedDrawing;
use Core\PhpSpreadsheet\Shared\Escher;
use Core\PhpSpreadsheet\Shared\Escher\DgContainer;
use Core\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer;
use Core\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use Core\PhpSpreadsheet\Shared\Escher\DggContainer;
use Core\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer;
use Core\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use Core\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use Core\PhpSpreadsheet\Shared\OLE;
use Core\PhpSpreadsheet\Shared\OLE\PPS\File;
use Core\PhpSpreadsheet\Shared\OLE\PPS\Root;
use Core\PhpSpreadsheet\Spreadsheet;
use Core\PhpSpreadsheet\Worksheet\BaseDrawing;
use Core\PhpSpreadsheet\Worksheet\Drawing;
...
class Xls extends BaseWriter
{
    ...
    /**
     * @var \Core\PhpSpreadsheet\Writer\Xls\Workbook
     */
    private $writerWorkbook;

    /**
     * @var \Core\PhpSpreadsheet\Writer\Xls\Worksheet[]
     */
    ...
    private function buildWorksheetEschers(): void
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \Core\PhpSpreadsheet\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
