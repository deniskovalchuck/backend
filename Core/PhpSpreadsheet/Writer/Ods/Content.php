...
use Core\PhpSpreadsheet\Worksheet\Row;
use Core\PhpSpreadsheet\Worksheet\Worksheet;
use Core\PhpSpreadsheet\Writer\Exception;
use Core\PhpSpreadsheet\Writer\Ods\Cell\Comment;
...
class Content extends WriterPart
{
    ...
    private function writeCells(XMLWriter $objWriter, Row $row): void
    {
        ...
        while ($cells->valid()) {
            /** @var \Core\PhpSpreadsheet\Cell\Cell $cell */
            $cell = $cells->current();
