...
use Core\PhpSpreadsheet\Worksheet\AutoFilter\Column;
use Core\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule;
use Core\PhpSpreadsheet\Worksheet\SheetView;
use Core\PhpSpreadsheet\Worksheet\Worksheet as PhpspreadsheetWorksheet;
...
class Worksheet extends WriterPart
{
    ...
    private function writeDrawings(XMLWriter $objWriter, PhpspreadsheetWorksheet $pSheet, $includeCharts = false): void
    {
        ...
        if (isset($unparsedLoadedData['sheets'][$pSheet->getCodeName()]['drawingOriginalIds'])) {
            ...
            // (! synchronize with \Core\PhpSpreadsheet\Writer\Xlsx\Rels::writeWorksheetRelationships)
