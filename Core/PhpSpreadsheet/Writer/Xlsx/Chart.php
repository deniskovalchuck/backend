...
use Core\PhpSpreadsheet\Chart\Axis;
use Core\PhpSpreadsheet\Chart\DataSeries;
use Core\PhpSpreadsheet\Chart\DataSeriesValues;
use Core\PhpSpreadsheet\Chart\GridLines;
use Core\PhpSpreadsheet\Chart\Layout;
use Core\PhpSpreadsheet\Chart\Legend;
use Core\PhpSpreadsheet\Chart\PlotArea;
use Core\PhpSpreadsheet\Chart\Title;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\Core\PhpSpreadsheet\Chart\Chart $pChart, $calculateCellValues = true)
    {
     ...
     * @param Axis $yAxis
     */
    private function writePlotArea(XMLWriter $objWriter, \Core\PhpSpreadsheet\Worksheet\Worksheet $pSheet, PlotArea $plotArea, ?Title $xAxisLabel = null, ?Title $yAxisLabel = null, ?Axis $xAxis = null, ?Axis $yAxis = null, ?GridLines $majorGridlines = null, ?GridLines $minorGridlines = null): void
    {
        if ($plotArea === null) {
            return;
        }
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \Core\PhpSpreadsheet\Chart\Layout $chartLayout Chart layout
     */
