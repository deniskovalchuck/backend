...
use Core\PhpSpreadsheet\Cell\Cell;
use Core\PhpSpreadsheet\Cell\Coordinate;
use Core\PhpSpreadsheet\Chart\Chart;
...
use Core\PhpSpreadsheet\Shared\Font as SharedFont;
...
class Html extends BaseWriter
{
     ...
     *
     * @param Worksheet $pSheet \Core\PhpSpreadsheet\Worksheet\Worksheet
    ...
    /**
     * Create CSS style (\Core\PhpSpreadsheet\Style\Alignment).
     *
     * @param Alignment $pStyle \Core\PhpSpreadsheet\Style\Alignment
     *
     * @return array
     */
    ...
    /**
     * Create CSS style (\Core\PhpSpreadsheet\Style\Font).
     *
     * @return array
     */
    ...
    private function generateRowWriteCell(&$html, $pSheet, $coordinate, $cellType, $cellData, $colSpan, $rowSpan, $cssClass, $colNum, $sheetIndex, $pRow): void
    {
        ...
        if (!$this->useInlineCss && !$this->isPdf) {
            ...
            //** Necessary redundant code for the sake of \Core\PhpSpreadsheet\Writer\Pdf **
    ...
    private function generatePageDeclarations($generateSurroundingHTML)
    {
        ...
        foreach ($sheets as $pSheet) {
            ...
            if ($orientation === \Core\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_LANDSCAPE) {
                $htmlPage .= 'size: landscape; ';
            } elseif ($orientation === \Core\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_PORTRAIT) {
