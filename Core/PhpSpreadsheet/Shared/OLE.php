...
use Core\PhpSpreadsheet\Reader\Exception as ReaderException;
use Core\PhpSpreadsheet\Shared\OLE\ChainedBlockStream;
...
class OLE
{
     ...
     * use \Core\PhpSpreadsheet\Shared\OLE\PPS\File::getStream().
     *
