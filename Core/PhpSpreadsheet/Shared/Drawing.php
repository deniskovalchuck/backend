...
class Drawing
{
     ...
     *
     * @param int $pValue Value in pixels
     * @param \Core\PhpSpreadsheet\Style\Font $pDefaultFont Default font of the workbook
     *
     * @return int Value in cell dimension
     */
    public static function pixelsToCellDimension($pValue, \Core\PhpSpreadsheet\Style\Font $pDefaultFont)
    {
        // Font name and size
     ...
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($pValue, \Core\PhpSpreadsheet\Style\Font $pDefaultFont)
    {
        // Font name and size
        $name = $pDefaultFont->getName();
        $size = $pDefaultFont->getSize();
