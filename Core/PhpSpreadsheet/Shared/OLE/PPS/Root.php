...
namespace Core\PhpSpreadsheet\Shared\OLE\PPS;
...
use Core\PhpSpreadsheet\Shared\OLE\PPS;
...
class Root extends PPS
{
    ...
    /**
     * Saving big data (PPS's with data bigger than \Core\PhpSpreadsheet\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param int $iStBlk
    ...
    /**
     * get small data (PPS's with data smaller than \Core\PhpSpreadsheet\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param array &$raList Reference to array of PPS's
     *
     * @return string
