...
namespace Core\PhpSpreadsheet\Shared;
...
class Font
{
     ...
     *
     * @param \Core\PhpSpreadsheet\Style\Font $font Font object
     * @param RichText|string $cellText Text to calculate width
     * @param int $rotation Rotation angle
     * @param null|\Core\PhpSpreadsheet\Style\Font $defaultFont Font object
     *
     * @return int Column width
     */
    public static function calculateColumnWidth(\Core\PhpSpreadsheet\Style\Font $font, $cellText = '', $rotation = 0, ?\Core\PhpSpreadsheet\Style\Font $defaultFont = null)
    {
     ...
     *
     * @param string $text
     * @param \Core\PhpSpreadsheet\Style\Font
     * @param int $rotation
     *
     * @return int
     */
    public static function getTextWidthPixelsExact($text, \Core\PhpSpreadsheet\Style\Font $font, $rotation = 0)
    {
     ...
     */
    public static function getTextWidthPixelsApprox($columnText, \Core\PhpSpreadsheet\Style\Font $font, $rotation = 0)
    {
     ...
     *
     * @param \Core\PhpSpreadsheet\Style\Font $font
     *
     ...
     *
     * @param \Core\PhpSpreadsheet\Style\Font $font The workbooks default font
     * @param bool $pPixels true = return column width in pixels, false = return in OOXML units
     *
     * @return mixed Column width
     */
    public static function getDefaultColumnWidthByFont(\Core\PhpSpreadsheet\Style\Font $font, $pPixels = false)
    {
     ...
     */
    public static function getDefaultRowHeightByFont(\Core\PhpSpreadsheet\Style\Font $font)
    {
        switch ($font->getName()) {
            case 'Arial':
                switch ($font->getSize()) {
