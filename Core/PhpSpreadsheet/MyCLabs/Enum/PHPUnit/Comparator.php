...
namespace Core\PhpSpreadsheet\MyCLabs\Enum\PHPUnit;

use Core\PhpSpreadsheet\MyCLabs\Enum\Enum;
 ...
 *
 * \SebastianBergmann\Comparator\Factory::getInstance()->register(new \Core\PhpSpreadsheet\MyCLabs\Enum\PHPUnit\Comparator());
 */
