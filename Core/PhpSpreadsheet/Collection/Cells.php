...
use Core\PhpSpreadsheet\Psr\SimpleCache\CacheInterface;

class Cells
{
    /**
     * @var \Core\PhpSpreadsheet\Psr\SimpleCache\CacheInterface
     */
    private $cache;
     ...
     * @param Cell $cell Cell to update
     *
     * @return \Core\PhpSpreadsheet\Cell\Cell
     */
     ...
     *
     * @return null|\Core\PhpSpreadsheet\Cell\Cell Cell that was found, or null if not found
     */
