...
namespace Core\PhpSpreadsheet\Reader\Xlsx;
...
class Chart
{
     ...
     *
     * @return \Core\PhpSpreadsheet\Chart\Chart
     */
    public static function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \Core\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, $dispBlanksAs, $XaxisLabel, $YaxisLabel);
