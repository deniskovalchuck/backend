...
use Core\PhpSpreadsheet\Shared\CodePage;
use Core\PhpSpreadsheet\Shared\Date;
use Core\PhpSpreadsheet\Shared\Escher;
use Core\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use Core\PhpSpreadsheet\Shared\File;
use Core\PhpSpreadsheet\Shared\OLE;
use Core\PhpSpreadsheet\Shared\OLERead;
...
use Core\PhpSpreadsheet\Style\Font;
        ...
        foreach ($this->sheets as $sheet) {
            ...
            foreach ($this->objs as $n => $obj) {
                ...
                if (isset($allSpContainers[$n + 1]) && is_object($allSpContainers[$n + 1])) {
                    ...
                    $width = \Core\PhpSpreadsheet\Shared\Xls::getDistanceX($this->phpSheet, $startColumn, $startOffsetX, $endColumn, $endOffsetX);
                    $height = \Core\PhpSpreadsheet\Shared\Xls::getDistanceY($this->phpSheet, $startRow, $startOffsetY, $endRow, $endOffsetY);

                    // calculate offsetX and offsetY of the shape
                    $offsetX = $startOffsetX * \Core\PhpSpreadsheet\Shared\Xls::sizeCol($this->phpSheet, $startColumn) / 1024;
                    $offsetY = $startOffsetY * \Core\PhpSpreadsheet\Shared\Xls::sizeRow($this->phpSheet, $startRow) / 256;
