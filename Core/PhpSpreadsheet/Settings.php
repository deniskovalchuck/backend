...
namespace Core\PhpSpreadsheet;

use Core\PhpSpreadsheet\Calculation\Calculation;
use Core\PhpSpreadsheet\Chart\Renderer\IRenderer;
use Core\PhpSpreadsheet\Collection\Memory;
...
class Settings
{
     ...
     * eg: Core\PhpSpreadsheet\Chart\Renderer\JpGraph.
     *
     * @var string
     */
