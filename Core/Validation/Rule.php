...
use Core\Validation\MissingRequiredParameterException;
...
abstract class Rule
{
    ...
    /** @var Core\Validation\Attribute|null */
    protected $attribute;

    /** @var Core\Validation\Validation|null */
     ...
     *
     * @param Core\Validation\Validation $validation
     * @return void
     */
     ...
     * Set attribute
     *
     * @param Core\Validation\Attribute $attribute
     * @return void
     */
     ...
     * Get attribute
     *
     * @return Core\Validation\Attribute|null
     */
     ...
     * @param array $params
     * @return void
     * @throws Core\Validation\MissingRequiredParameterException
     */
