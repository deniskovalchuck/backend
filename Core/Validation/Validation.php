...
use Closure;
use Core\Validation\Rules\Interfaces\BeforeValidate;
use Core\Validation\Rules\Interfaces\ModifyValue;
...
class Validation
{
     ...
     *
     * @param string $attributeKey
     * @return null|Core\Validation\Attribute
     */
     ...
     *
     * @return Core\Validation\ErrorBag
     */
     ...
     * @param Core\Validation\Attribute $attribute
     * @param mixed $value
     * @param Core\Validation\Rule $ruleValidator
     * @return void
     */
     ...
     *
     * @param Core\Validation\Attribute $attribute
     * @param Core\Validation\Rule $rule
     * @return bool
     */
     ...
     * @param Core\Validation\Attribute $attribute
     * @param mixed $value
     * @param Core\Validation\Rule $validator
     * @return mixed
     */
